...
DATA_DIR = "/var/lib/localstack/state"

APP_NAME = os.getenv("SPRING_APPLICATION_NAME")
AWS_DEFAULT_REGION = os.environ['SPRING_CLOUD_AWS_REGION_STATIC']
AWS_ENDPOINT = os.environ['SPRING_CLOUD_AWS_ENDPOINT']
